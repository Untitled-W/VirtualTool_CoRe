...
output_folder = "/home/guchenyang/Codes/tool-games/environment/Trials/Generated/Bridge/move"

for i in range(1, 51):
    for j in range(1, 51):
        index = (i - 1) * 50 + j
        file_name = "/home/guchenyang/Codes/tool-games/environment/Trials/Generated/Bridge/jsons/1.json"
