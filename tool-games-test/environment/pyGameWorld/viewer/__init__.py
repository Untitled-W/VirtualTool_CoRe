...
__all__ = ['drawWorld', 'demonstrateWorld', 'demonstrateTPPlacement',
           ...
           'drawMultiPathSingleImage', 'drawMultiPathSingleImageBasic', '_draw_obj']
...
def demonstrateTPPlacement_test(toolpicker, toolname1, position1, toolname2=None, position2=None, maxtime=20.,
                                noise_dict=None, hz=30):
    import pygame as pg
    ...
    toolpicker.bts = tps
    if noise_dict:
        pth, ocm, etime, wd = toolpicker.runFullNoisyPath(toolname1, position1, maxtime, returnDict=True, **noise_dict)
    else:
        pth, ocm, etime, wd = toolpicker.observeFullPlacementPath_test(toolname1, position1, toolname2, position2, maxtime, returnDict=True)
    ...
    pg.image.save(sc, first_frame_path)
