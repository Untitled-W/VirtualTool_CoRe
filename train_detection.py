...
file_path = './catapult_data_2.json'
dataset = DetectionDataset(name='catapult', file_path=file_path)
...
device = 'cpu'  # Or use 'cuda' if you have a GPU
...
torch.save(model.state_dict(), './catapult_detector.pth')